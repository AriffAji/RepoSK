...
<body class="bg-gradient-to-br from-gray-100 to-gray-200 min-h-screen">
        ...
        <div class="max-w-6xl mx-auto py-12 px-4">
            ...
            {{-- Loading Skeleton --}}
            <div id="skeleton"
                class="grid gap-6 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 mb-6" data-aos="fade-up" >
            ...
            {{-- REAL CONTENT --}}
            <div id="content" class="grid gap-6 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 hidden" data-aos="fade-up">
